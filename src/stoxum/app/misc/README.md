...
native currency, STM. Fees for transactions are paid directly from the account
...
may want to change fees is when the value of the native currency STM fluctuates
